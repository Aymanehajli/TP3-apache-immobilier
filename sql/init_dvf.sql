-- Creation de la base de donnees dediee aux donnees DVF
CREATE DATABASE dvf;
\c dvf;

-- -----------------------------------------------------------------
-- Table 1 : Transactions brutes Paris (chargees depuis HDFS)
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------
-- Table 2 : Prix agreges par arrondissement (zone curated)
-- -----------------------------------------------------------------
...
-- -----------------------------------------------------------------
-- Table 3 : Statistiques globales du marche parisien
-- -----------------------------------------------------------------
CREATE TABLE IF NOT EXISTS stats_marche (
    ...
    arrdt_plus_hausse INTEGER,
    arrdt_plus_baisse INTEGER,
    variation_max_pct NUMERIC(10, 2),
    variation_min_pct NUMERIC(10, 2),
    tendance_moyenne_pct NUMERIC(10, 2),
